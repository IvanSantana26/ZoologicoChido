...
public class Fragment_Modificar extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        a5=(CheckBox) view.findViewById(R.id.checkBox);
        a7=(CheckBox) view.findViewById(R.id.checkBox2);
            ...
            public void onClick(View view) {
                ...
                if(!a1.getText().toString().equals("")&&!a2.getText().toString().equals("")&&!a3.getText().toString().equals("")&&
                    ...
                    if (a5.isChecked()){
                        ...
                        Toast.makeText(getContext(), "Error: Seleccione un sexo", Toast.LENGTH_SHORT).show();
                    }
